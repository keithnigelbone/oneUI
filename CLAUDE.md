...
Shape numeric sizes (`0`–`10`) **derive from the dimension f-step scale**, exactly like spacing. This makes them responsive to platform and density changes via the dimension cascade. `Shape-Pill` (9999px) is a **standalone constant** — NOT part of the numeric scale.
...
| **Other interactive** (inputs, chips, selects)  | Subtle radius | `Shape-2` (f-4)       | Per-component defaults               |
| **Non-interactive** (cards, containers)         | Token         | `Shape-3`–`Shape-10`  | Derived from dimension scale         |
...
<!-- INTENTIONAL-LEGACY-VOCAB: this table names deprecated aliases so agents
     and contributors know what not to author in new component code. -->
...
- **Spacing**: `Spacing-0`, `Spacing-0-5`, `Spacing-1`, `Spacing-1-5`, `Spacing-2`, `Spacing-2-5`, `Spacing-3`, `Spacing-3-5`, `Spacing-4`, `Spacing-4-5`, `Spacing-5`, `Spacing-5-5`, `Spacing-6`, `Spacing-7`, `Spacing-8`, `Spacing-9`, `Spacing-10`, `Spacing-12`, `Spacing-14`, `Spacing-16`, `Spacing-18`, `Spacing-20`, `Spacing-24`, `Spacing-28`, `Spacing-32`, `Spacing-40`, plus `Spacing-Margin` and `Spacing-Gutter`
- **Shape**: `Shape-Pill` (9999px standalone), `Shape-0` through `Shape-10` (derived from dimension f-steps)
...
- `[starter-mcp/](starter-mcp/)` — The One UI MCP server (`@jds4/oneui-mcp`) / `oneui` Claude Code plugin: offline knowledge snapshot, component/brand catalogs, `validate_oneui_code`, `figma_to_code`. Standalone npm package (NOT in the pnpm workspace — run npm from `starter-mcp/`). Install: `[starter-mcp/INSTALL.md](starter-mcp/INSTALL.md)`. Audit + backlog: `[docs/mcp-audit-2026-07.md](docs/mcp-audit-2026-07.md)`

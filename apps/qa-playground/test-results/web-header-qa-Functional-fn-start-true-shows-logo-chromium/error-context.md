...
- Name: web-header-qa.spec.ts >> Functional >> [fn] start=true shows logo
- Location: e2e/web-header-qa.spec.ts:126:3
...
Locator: getByTestId('web-header-start-true').locator('[data-oneui-component="Logo"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('web-header-start-true').locator('[data-oneui-component="Logo"]')
        ...
        - region "Test report" [ref=e88]:
          ...
          - generic [ref=e101]:
            - status "Report fetched time" [ref=e102]:
              - generic [ref=e103]: Fetched 09-Jul-26 8:08 PM (just now)

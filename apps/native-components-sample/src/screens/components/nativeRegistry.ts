...
export const NATIVE_REGISTRY: readonly NativeComponentEntry[] = [
  ...
  { id: 'iconbutton',     name: 'IconButton',     category: 'Inputs', hasNativeImpl: true },
  { id: 'singletextbutton', name: 'SingleTextButton', category: 'Inputs', hasNativeImpl: true },
  { id: 'buttoncopy',     name: 'ButtonCopy',     category: 'Inputs', hasNativeImpl: false },
  { id: 'input',          name: 'Input',          category: 'Inputs', hasNativeImpl: true },
  { id: 'inputfield',     name: 'InputField',     category: 'Inputs', hasNativeImpl: true },
  { id: 'inputdynamictext', name: 'InputDynamicText', category: 'Inputs', hasNativeImpl: true },
  { id: 'textarea',       name: 'TextArea',       category: 'Inputs', hasNativeImpl: false },
  { id: 'select',         name: 'Select',         category: 'Inputs', hasNativeImpl: true },
  { id: 'combobox',       name: 'Combobox',       category: 'Inputs', hasNativeImpl: false },
  { id: 'checkbox',       name: 'Checkbox',       category: 'Inputs', hasNativeImpl: true },
  { id: 'checkboxfield',  name: 'CheckboxField',  category: 'Inputs', hasNativeImpl: true },
  { id: 'radio',          name: 'Radio',          category: 'Inputs', hasNativeImpl: true },
  { id: 'radiofield',     name: 'RadioField',     category: 'Inputs', hasNativeImpl: true },
  { id: 'switch',         name: 'Switch',         category: 'Inputs', hasNativeImpl: true },
  { id: 'touchslider',    name: 'TouchSlider',    category: 'Inputs', hasNativeImpl: true },
  { id: 'slider',         name: 'Slider',         category: 'Inputs', hasNativeImpl: true },
  ...
  { id: 'icon',           name: 'Icon',           category: 'Data Display', hasNativeImpl: true },
  { id: 'iconcontained',  name: 'IconContained',  category: 'Data Display', hasNativeImpl: true },
  ...
  { id: 'chip',           name: 'Chip',           category: 'Data Display', hasNativeImpl: true },
  { id: 'chipgroup',      name: 'ChipGroup',      category: 'Data Display', hasNativeImpl: true },
  { id: 'tag',            name: 'Tag',            category: 'Data Display', hasNativeImpl: false },
  { id: 'card',           name: 'Card',           category: 'Data Display', hasNativeImpl: true },
  ...
  { id: 'tooltip',        name: 'Tooltip',        category: 'Data Display', hasNativeImpl: true },
  ...
  { id: 'text',           name: 'Text',           category: 'Data Display', hasNativeImpl: true },

  // ── Navigation ───────────────────────────────────────────────────────
  { id: 'tabs',           name: 'Tabs',           category: 'Navigation', hasNativeImpl: true },
  { id: 'segmentedcontrol', name: 'SegmentedControl', category: 'Navigation', hasNativeImpl: true },
  { id: 'breadcrumbs',    name: 'Breadcrumbs',    category: 'Navigation', hasNativeImpl: false },
  { id: 'pagination',     name: 'Pagination',     category: 'Navigation', hasNativeImpl: true },
  ...
  { id: 'bottomnavigation', name: 'BottomNavigation', category: 'Navigation', hasNativeImpl: true },
  { id: 'headernative',     name: 'HeaderNative',     category: 'Navigation', hasNativeImpl: true },
  { id: 'headeritem',       name: 'HeaderItem',       category: 'Navigation', hasNativeImpl: true },
  ...
  { id: 'modal',          name: 'Modal',          category: 'Feedback', hasNativeImpl: true },
  ...
  { id: 'circularprogressindicator', name: 'CircularProgressIndicator', category: 'Feedback', hasNativeImpl: true },
  ...
  { id: 'inputfeedback',  name: 'InputFeedback',  category: 'Feedback', hasNativeImpl: true },
  { id: 'agentpulse',     name: 'AgentPulse',     category: 'Feedback', hasNativeImpl: true },
  { id: 'emptystate',     name: 'EmptyState',     category: 'Feedback', hasNativeImpl: false },

  // ── Layout ───────────────────────────────────────────────────────────
  { id: 'materials',      name: 'Materials (Metallic)',  category: 'Layout', hasNativeImpl: true },
  ...
  { id: 'carousel',       name: 'Carousel',       category: 'Layout', hasNativeImpl: true },
  { id: 'scrollarea',     name: 'ScrollArea',     category: 'Layout', hasNativeImpl: false },
  { id: 'scrim',          name: 'Scrim',          category: 'Layout', hasNativeImpl: true },

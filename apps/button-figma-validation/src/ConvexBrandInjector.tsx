/**
 * Mirrors `apps/storybook/.storybook/BrandStyleDecorator.tsx` for the Button
 * Figma parity Vite page: Convex-backed foundation + dimensions + component
 * overrides, same hooks as Storybook preview.
 */
...
const DIMENSION_STYLE_ID = 'figma-parity-dimension-tokens';
const COMPONENT_STYLE_ID = 'figma-parity-component-tokens';

export function ConvexBrandInjector({
  brandId,
  theme = 'light',
  children,
}: {
  ...
  const foundationData = useQuery(api.foundations.getBrandOverviewData, { brandId: typedBrandId });

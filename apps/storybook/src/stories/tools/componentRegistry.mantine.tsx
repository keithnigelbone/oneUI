...
// ---------------------------------------------------------------------------
// Mantine — static CSS + CSS vars. Requires <MantineProvider> in the tree
// (wired in PerformanceTool.tsx when this chunk loads).
// ---------------------------------------------------------------------------
...
export const MANTINE_COMPONENTS: TestComponentEntry[] = [
  ...
  },
  {
    id: 'mantine:link',
    familyKey: 'anchor',
    label: 'Mantine Anchor',
    library: 'mantine',
    renderInstance: (i, tick) => (
      <MantineAnchor key={i} href="#">{`Link ${i}·${tick}`}</MantineAnchor>
    ),
  },
  {
    id: 'mantine:badge',
  ...
  },
  {
    id: 'mantine:progress',
    familyKey: 'progress',
    label: 'Mantine Progress',
    library: 'mantine',
    renderInstance: (i, tick) => (
      <MantineProgress key={i} value={(tick * 3 + i) % 100} style={{ width: 120 }} />
    ),
  },
  {
    id: 'mantine:spinner',

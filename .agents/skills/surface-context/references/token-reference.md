...
|-------|---------|---------------|
| `--Primary-Default` | `#ffffff` (light) | Step 2500 (light) or 200 (dark) |
...
6 solid tokens per role remain for compatibility with components that replace background color:

| Token | Base | Offset |
|-------|------|--------|
| `--Primary-Hover` | Parent | +1 step toward contrast |
| `--Primary-Pressed` | Parent | +2 steps toward contrast |
| `--Primary-Bold-Hover` | Bold | +3 steps |
| `--Primary-Bold-Pressed` | Bold | +5 steps |
| `--Primary-Subtle-Hover` | Subtle | +1 step |
| `--Primary-Subtle-Pressed` | Subtle | +2 steps |

6 state-layer tokens per role mirror the plugin/Figma overlay model:

| Token | Base | Overlay |
|-------|------|---------|
| `--Primary-Hover-Layer` | Parent | `parentStep + dir * 800`, opacity 0.16 |
| `--Primary-Pressed-Layer` | Parent | `parentStep + dir * 800`, opacity 0.24 |
| `--Primary-Bold-Hover-Layer` | Parent | `parentStep + dir * 800`, opacity 0.24 |
| `--Primary-Bold-Pressed-Layer` | Parent | `parentStep + dir * 800`, opacity 0.32 |
| `--Primary-Subtle-Hover-Layer` | Parent | `parentStep + dir * 800`, opacity 0.16 |
| `--Primary-Subtle-Pressed-Layer` | Parent | `parentStep + dir * 800`, opacity 0.24 |

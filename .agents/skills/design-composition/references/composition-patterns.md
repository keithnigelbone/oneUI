...
<main style={{ padding: 'var(--Spacing-Margin)' }}>
  ...
  <div style={{ display: 'flex', gap: 'var(--Spacing-3XS)', padding: 'var(--Spacing-M) 0' }}>
  ...
  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(160px, 1fr))', gap: 'var(--Spacing-M)' }}>
    <article>
...
<main>
  ...
  <section style={{ padding: 'var(--Spacing-Margin)', display: 'flex', flexDirection: 'column', gap: 'var(--Spacing-M)' }}>
...
```tsx
<main style={{ padding: 'var(--Spacing-Margin)', display: 'flex', flexDirection: 'column', gap: 'var(--Spacing-4XL)' }}>
  <h1 style={{ font: 'var(--Headline-L-FontSize)/var(--Headline-L-LineHeight) var(--Typography-Font-Primary)', fontWeight: 'var(--Headline-L-FontWeight)' }}>
    Settings
  </h1>

  {/* Settings group -- bg-subtle for visual grouping */}
  <Surface mode="bg-subtle">
    <section style={{ padding: 'var(--Spacing-M)', borderRadius: 'var(--Shape-4)', display: 'flex', flexDirection: 'column', gap: 'var(--Spacing-2XS)' }}>
  ...
  {/* Another group */}
  <Surface mode="bg-subtle">
    <section style={{ padding: 'var(--Spacing-M)', borderRadius: 'var(--Shape-4)' }}>
      <h2>Language</h2>
      <Radio.Group>
...
**Key decisions**:
- Groups use `<Surface mode="bg-subtle">` for visual separation -- the only non-default surface on the page
...
<Surface mode="fg-bold">
  <section style={{ padding: 'var(--Spacing-7XL) var(--Spacing-Margin)', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'var(--Spacing-2XL)' }}>
    ...
    {/* CTA -- bold variant auto-inverts on fg-bold surface */}
...
<section style={{ padding: 'var(--Spacing-7XL) var(--Spacing-Margin)' }}>
...
**Key decisions**:
- `<Surface mode="fg-bold">` creates the bold brand moment -- text and buttons auto-adapt
- `Display-L` with negative letter-spacing for cinematic headline
- Bold button auto-inverts to tinted accent fill on fg-bold surface (brand bold inversion)
- Ghost button gets white text + light border on fg-bold surface
...
```tsx
<main style={{ padding: 'var(--Spacing-Margin)', display: 'flex', flexDirection: 'column', gap: 'var(--Spacing-3XL)' }}>
  <header>
    <h1 style={{ font: 'var(--Headline-L-FontSize)/var(--Headline-L-LineHeight) var(--Typography-Font-Primary)', fontWeight: 'var(--Headline-L-FontWeight)' }}>
      Dashboard
    </h1>
  ...
  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 'var(--Spacing-M)' }}>
    <article style={{ padding: 'var(--Spacing-M)', borderRadius: 'var(--Shape-4)', border: '1px solid var(--Border-Subtle)' }}>
...
- Metric cards use subtle border (`var(--Border-Subtle)`) instead of shadow or bg-subtle
...
```tsx
<main style={{ padding: 'var(--Spacing-Margin)', maxWidth: '600px', display: 'flex', flexDirection: 'column', gap: 'var(--Spacing-3XL)' }}>
  <h1 style={{ font: 'var(--Headline-L-FontSize)/var(--Headline-L-LineHeight) var(--Typography-Font-Primary)', fontWeight: 'var(--Headline-L-FontWeight)' }}>
    Create Account
  </h1>

  <form style={{ display: 'flex', flexDirection: 'column', gap: 'var(--Spacing-XL)' }}>
    {/* Input group */}
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--Spacing-5XS)' }}>
      ...
      <input style={{ borderRadius: 'var(--Shape-2)', padding: 'var(--Spacing-2XS) var(--Spacing-M)', border: 'var(--Stroke-M) solid var(--Border-Default)', font: 'var(--Body-M-FontSize)/var(--Body-M-LineHeight) var(--Typography-Font-Primary)' }} />
    </div>

...
| `--Shape-None` | 0px | Sharp edges, full-bleed |
| `--Shape-6XS` | f-7 = 2px | Minimal rounding |
| `--Shape-5XS` | f-6 = 4px | Subtle rounding |
| `--Shape-4XS` | f-5 = 6px | Small element rounding |
| `--Shape-3XS` | f-4 = 8px | Input fields, small containers |
| `--Shape-2XS` | f-3 = 10px | Medium-small containers |
| `--Shape-XS` | f-2 = 12px | Small cards |
| `--Shape-S` | f-1 = 14px | Medium cards |
| `--Shape-M` | f0 = 16px | Standard cards, FAB |
| `--Shape-L` | f1 = 18px | Large cards, modals |
| `--Shape-XL` | f2 = 20px | Large containers |
| `--Shape-2XL` | f3 = 24px | Extra-large containers |
| `--Shape-3XL` | f4 = 28px | Hero sections |
| `--Shape-4XL` | f5 = 32px | Large panels |
| `--Shape-5XL` | f6 = 36px | Full-width cards |
| `--Shape-6XL` | f7 = 40px | Maximum scale rounding |

...
<main style={{ padding: 'var(--Spacing-Margin)', display: 'flex', flexDirection: 'column', gap: 'var(--Spacing-4XL)' }}>
  ...
  <Surface mode="subtle">
    <section style={{ padding: 'var(--Spacing-M)', borderRadius: 'var(--Shape-M)', display: 'flex', flexDirection: 'column', gap: 'var(--Spacing-2XS)' }}>
  ...
  {/* Another group */}
  <Surface mode="subtle">
    <section style={{ padding: 'var(--Spacing-M)', borderRadius: 'var(--Shape-M)' }}>
      <h2>Language</h2>
      <Radio.Group>
...
<main style={{ padding: 'var(--Spacing-Margin)', display: 'flex', flexDirection: 'column', gap: 'var(--Spacing-3XL)' }}>
  ...
  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 'var(--Spacing-M)' }}>
    <article style={{ padding: 'var(--Spacing-M)', borderRadius: 'var(--Shape-M)', border: '1px solid var(--Border-Subtle)' }}>
...
<main style={{ padding: 'var(--Spacing-Margin)', maxWidth: '600px', display: 'flex', flexDirection: 'column', gap: 'var(--Spacing-3XL)' }}>
  ...
  <form style={{ display: 'flex', flexDirection: 'column', gap: 'var(--Spacing-XL)' }}>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--Spacing-5XS)' }}>
      ...
      <input style={{ borderRadius: 'var(--Shape-3XS)', padding: 'var(--Spacing-2XS) var(--Spacing-M)', border: 'var(--Stroke-M) solid var(--Border-Default)', font: 'var(--Body-M-FontSize)/var(--Body-M-LineHeight) var(--Typography-Font-Primary)' }} />
    </div>
    ...
    <div>
      ...
      <input style={{ borderRadius: 'var(--Shape-3XS)', border: 'var(--Stroke-XL) solid var(--Negative-Default-Accent)' }} />
...
- Inputs: `Shape-3XS` (8px) border-radius -- subtle, container feel

/**
 * IndicatorBadge.recipe.ts
 *
 * Recipe definition for the IndicatorBadge component.
 * Defines 1 design decision that deterministically resolves to token overrides.
 *
 * Decisions:
...
export const INDICATOR_BADGE_RECIPE_DEFINITION: ComponentRecipeDefinition = {

/**
 * SelectableSingleTextButton.recipe.ts
 *
 * Recipe definition for the SelectableSingleTextButton component.
 * Defines 1 design decision: corner radius (shape).
 */

import type { ComponentRecipeDefinition } from '@oneui/shared';

export const SELECTABLE_SINGLE_TEXT_BUTTON_RECIPE_DEFINITION: ComponentRecipeDefinition = {

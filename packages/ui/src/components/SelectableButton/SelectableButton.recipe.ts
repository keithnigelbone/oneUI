/**
 * SelectableButton.recipe.ts
 *
 * Recipe definition for the SelectableButton component.
 * Defines 1 design decision: corner radius (shape).
 */

import type { ComponentRecipeDefinition } from '@oneui/shared';

export const SELECTABLE_BUTTON_RECIPE_DEFINITION: ComponentRecipeDefinition = {

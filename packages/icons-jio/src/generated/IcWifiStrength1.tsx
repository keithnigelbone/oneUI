...
export const IcWifiStrength1 = forwardRef<SVGSVGElement, IconComponentProps>(function IcWifiStrength1(
  ...
  return (
    ...
    >
      <path
            ...
            opacity={0.2}
          />
          <path fill="currentColor" d="M12 20a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3" />
    </svg>
  );
});

IcWifiStrength1.displayName = 'IcWifiStrength1';

...
export const IcJioDot = forwardRef<SVGSVGElement, IconComponentProps>(function IcJioDot(
  ...
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#ic_jio_dot_svg__a)">
            <rect width={24} height={24} fill="#3535F3" rx={12} />
            <path
              fill="#fff"

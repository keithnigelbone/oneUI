...
export const IcDataOut = forwardRef<SVGSVGElement, IconComponentProps>(function IcDataOut(
  ...
  return (
    ...
    >
      <path
            fill="currentColor"
            d="m21.71 8.29-4-4a1 1 0 0 0-1.42 0l-4 4a1 1 0 0 0 .325 1.639 1 1 0 0 0 1.095-.22L16 7.41V18a1 1 0 1 0 2 0V7.41l2.29 2.3a1.004 1.004 0 0 0 1.42-1.42"
          />
          <path
            fill="currentColor"
...
IcDataOut.displayName = 'IcDataOut';

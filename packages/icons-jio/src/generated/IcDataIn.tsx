...
export const IcDataIn = forwardRef<SVGSVGElement, IconComponentProps>(function IcDataIn(
  ...
  return (
    ...
    >
      <path
          ...
          <path
            fill="currentColor"
            d="M11.71 14.29a1 1 0 0 0-1.42 0L8 16.59V6a1 1 0 0 0-2 0v10.59l-2.29-2.3a1.004 1.004 0 1 0-1.42 1.42l4 4a1 1 0 0 0 1.42 0l4-4a1 1 0 0 0 0-1.42"
          />
    </svg>
  );
});

IcDataIn.displayName = 'IcDataIn';

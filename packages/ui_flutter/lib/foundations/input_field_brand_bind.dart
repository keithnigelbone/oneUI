...
/// Subscribes to [OneUiScope] + [OneUiBrandLoadState] so InputField trees repaint on brand switch.
void bindInputFieldBrandScope(BuildContext context) {
...
String inputFieldBrandScopeKey(BuildContext context) {

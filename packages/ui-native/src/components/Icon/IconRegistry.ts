/**
 * Native icon registry + semantic mappings.
 *
 * Self-contained copy — does not import from @oneui/ui.
 * The data tables (IconSetRegistry, SemanticMappings, IconCategories) are
 * identical to those in @oneui/ui/icons/IconRegistry; keep them in sync when
 * adding new icon sets or semantic names.
 */

...
import Svg, { ClipPath, Defs, G, Line, LinearGradient, Path, Rect, Stop, type SvgProps } from 'react-native-svg';
export function IcJioDotJiofinanceColoured(props: SvgProps) {
